function [niceBarplot_figure] = lw_niceBARplot(meanvec,semvec,label_title,label_yaxis,label_xticks,limit_yaxis,varargin)
    ...
    default_cols = {'#272730','#B8357E','#272730','#B8357E','#272730','#B8357E','#272730','#B8357E','#235DB8'};
    default_legend = {};
    ...
    p.addParamValue('n3rd',default_n3rd,@isnumeric)
    ...
    barcolcount = 1;
    for barcol = 1:nbars
        set(ba(barcol),'color',rgbcol(barcol,:),'LineStyle',rgbline(barcol),'MarkerEdgeColor','none','MarkerFaceColor',rgbcol(barcol,:))
